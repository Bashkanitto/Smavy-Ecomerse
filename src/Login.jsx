const Login = () => {
  return (
    <div>
      <form className="flex flex-col items-center justify-between bg-slate-800 border border-slate-600 rounded-md p-8 shadow-lg backdrop-filter w-[354px] h-[382px]  backdrop-blur-lg bg-opacity-30 relative">
